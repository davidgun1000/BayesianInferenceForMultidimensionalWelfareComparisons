...
Post.w_gamma = (temp.w_gamma);
Post.m_gamma = (temp.m_gamma);
Post.v_gamma = (temp.v_gamma);

Post.w_beta = (temp.w_beta);
Post.m_beta = (temp.m_beta);
Post.s_beta = (temp.s_beta);

Post.delta_educ = (temp.delta_educ);
Post.prop_educ = (temp.prop_educ);

Post.delta_happiness = (temp.delta_happiness);
Post.prop_happiness = (temp.prop_happiness);

Post.theta_gauss = (temp.theta_gauss);
...
save('Simulation_result_v2.mat','Post');
