...
% rng(seednum);
function [prior,Post,V1_beta_com]=InitialSamplerBetaMix(data,num_component_beta)
prior.phi=1;
...
for i=1:s
    ...
    %w_beta'
    %m_beta'
    [w_beta,m_beta,s_beta,scale_beta_com,accept_w_beta,accept_beta_com]=sampling_beta_parameter_only_Mix(data,w_beta,m_beta,s_beta,prior,i,scale_beta_com,V1_beta_com,...
                                                                                                       accept_w_beta,accept_beta_com,num_component_beta,target_accept);
    ...
    temp.w_beta(i,:) = w_beta;
    temp.m_beta(i,:) = m_beta;
    temp.s_beta(i,:) = s_beta;    
