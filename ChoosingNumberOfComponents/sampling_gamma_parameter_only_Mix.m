...
function [w_gamma,m_gamma,v_gamma,scale_gamma_com,accept_w_gamma,accept_gamma_com] = sampling_gamma_parameter_only_Mix(data,...
    w_gamma,m_gamma,v_gamma,prior,iter,scale_gamma_com,V1_gamma_com,...
    accept_w_gamma,accept_gamma_com,num_component,target_accept)
